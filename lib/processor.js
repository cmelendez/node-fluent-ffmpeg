...
exports = module.exports = function Processor(command) {
  ...
  this._getProgressFromStdErr = function(stderrString, totalDurationSec) {
    ...
    if (typeof lastLine[lastLine.length - 2] === "undefined" || lastLine[lastLine.length - 2] === null || lastLine[lastLine.length - 2] === "undefined"){
      console.log("FLUENT-FFMPEG -> Catching progress error.");
    }else{
